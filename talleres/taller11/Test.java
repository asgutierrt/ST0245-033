...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println("    getSuccesors() -> " + convert(testSuccesorsMatrix(gMatrix)));
                */
		...
		System.out.println("    getSuccesors() -> " + convert(testSuccesorsArrayList(gList)));
	...
	static boolean testSuccesorsArrayList(Digraph g) {
